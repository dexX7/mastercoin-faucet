...
<?php
	...
	if($valid)
	{
		...
		if($user)
		{
			...
			{
				$formid = generateUid();
				$reserved = $sql->registerFormId($formid, $identifier, "google");
	...
	<?php } else { ?>
		...
		<p>You can <a href="/google-intro"><strong>click here</strong></a> to start the authentication via <strong>Google</strong> again.</p>
