...
<!-- Home -->
  ...
  <span class="description">
    <p>Mastercoin is an open source project driven by the members of the Bitcoin community that want to see more
    advanced features implimented on top of the blockchain.</p>    
    <p>Mastercoin enables the Bitcoin eco-system to become more decentralized and operate more in line with its 
