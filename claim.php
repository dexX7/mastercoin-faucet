...
<!-- Payout -->
  ...
  <?php if($result == "STATE_VALID") { ?>
    ...
    <div class="alert alert-success">
      <strong>Gratulations!</strong> We just sent you <?php echo $amount; ?> Mastercoin.
    </div>
	
    <span class="description">
      <p>The <strong>transaction id</strong> is <?php echo $pushedtxid; ?>.</p>
      <p>It may take a few minutes, but you can lookup the transaction for your 
      reward and all details on:</p>
    </span>
	
    <ul>
      <li><a href="http://mastercoin-explorer.com/transactions/<?php echo $pushedtxid; ?>" target="_blank">
	  <strong>mastercoin-explorer.com</strong></a></li>
      <li><a href="https://masterchest.info/lookuptx.aspx?txid=<?php echo $pushedtxid; ?>" target="_blank">
	  <strong>masterchest.info</strong></a></li>
      <li><a href="https://blockchain.info/tx/<?php echo $pushedtxid; ?>" target="_blank">
  ...
  <?php } else if($result == "STATE_NO_MORE_FUNDS") { ?>
    ...
    <span class="description">
      ...
      us via <a href="mailto:dexx@bitwatch.co"><strong>email</strong></a> and give us a headsup, so
  ...
  <?php } else if($result == "STATE_SESSION_ERROR") { ?>
    ...
    <span class="description">
      ...
      <p>If you think there shouldn't be a warning, please contact us via <a href="mailto:dexx@bitwatch.co">
  ...
  <?php } else if($result == "STATE_TRANSACTION_ERROR") { ?>
    ...
    <span class="description">
      ...
      <p>It would be very appreciated, if you contact us via <a href="mailto:dexx@bitwatch.co">
